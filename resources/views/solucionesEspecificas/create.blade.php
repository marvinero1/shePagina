...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><strong>Administración Soluciones Especificas</strong></h3>
            ...
            @endif
            <form action="{{route('solucionesEspecificas.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
...
<div class="container">
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                @foreach($soluEspecifica as $instructoritem)
                <tr>
