    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <div class="member-img">
                        <img src="images/Equipos/ambiental/1.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <br>
                        <h4>Particlas en Suspencion</h4>
            ...
            {{-- <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <div class="member-img">
                        <img src="/images/Equipos/ambiental/2.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <br>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
                    <div class="member">
                        <div class="member-img">
                            <img src="/images/Equipos/ambiental/4.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <br>
                            <h4>Gases de Combustion Interna</h4>
                            <p>Animi est delectus alias quam repellendus nihil nobis dolor. Est sapiente occaecati et
                                dolore. Omnis aut ut nesciunt explicabo qui. Eius nam deleniti ut omnis repudiandae
            ...
            <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <div class="member-img">
                        <img src="/images/Equipos/ambiental/3.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <br>
                        <h4>Vibraciones</h4>
