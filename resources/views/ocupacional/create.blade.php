...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><strong>Administración Monitoreo Ocupacional</strong></h3>
            ...
            @endif
            <form action="{{route('MoniOcupacional.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <form action="{{ route('MoniOcupacional.destroy',$instructoritem->id ) }}" method="POST"
