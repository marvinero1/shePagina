...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><strong>Administración Diagnostico Integrales</strong></h3>
            ...
            @endif
            <form action="{{route('diagnosticoIntegrales.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        <label><strong>Titulo *</strong> </label>
                        <input type="text" class="form-control" placeholder="Titulo Diagnostico" name="titulo" required>
                    </div>
                    <div class="col-md-6">
                        <label><strong>Descripción *</strong>  </label>
                        <input type="text" class="form-control" placeholder="Descripción Diagnostico" name="descripcion" required>
                    </div>
                </div>
                <br>
                <div class="row">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <form action="{{ route('diagnosticoIntegrales.destroy',$instructoritem->id ) }}" method="POST"
