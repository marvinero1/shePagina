...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"><strong>Administración Calculo Carga de Fuego</strong></h3>
            ...
            @endif
            <form action="{{route('CalCarga.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        <label><strong>Titulo *</strong> </label>
                        <input type="text" class="form-control" placeholder="Titulo Calculo Carga" name="titulo" required>
                    </div>
                    <div class="col-md-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="image-popup-vertical-fit" href="{{ $instructoritem->imagen }}">
                                <img src="/images/defaultBanco.jpg" class="img-thumbnail" alt="DPF" height="150px"
